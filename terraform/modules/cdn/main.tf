...
resource "aws_cloudfront_distribution" "main" {
  origin {
    domain_name              = var.primary_s3_domain_name
    origin_access_control_id = aws_cloudfront_origin_access_control.main.id
    origin_id                = "S3-${var.primary_s3_bucket_id}"
  }
  ...
  default_cache_behavior {
    ...
    target_origin_id = "S3-${var.primary_s3_bucket_id}"
  ...
  # Cache behavior for API requests (primary)
